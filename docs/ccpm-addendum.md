...
> **この文書について。** 複数セッションにまたがる調査を 1 本にまとめた正典である。検証の途中で **10 件の訂正**（過大評価 6・過小評価 4）が入っており、**訂正結果は本文に織り込み済み**。訂正の経緯そのものは[付録 A](#付録-a-検証履歴と訂正の記録)に、各主張の出典と裏付け／反証の突き合わせは[`docs/ccpm-evidence-review.md`](./ccpm-evidence-review.md) に分離した。
