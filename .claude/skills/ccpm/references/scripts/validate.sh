...
# github-mapping.md and execution-status.md are generated by the sync and execute
# phases as plain reports — their documented formats carry no frontmatter, so
# requiring it flags ccpm's own output as invalid.
