...
echo ""
echo "🎯 Next Steps:"
echo "  1. Create your first PRD — say: write a PRD for <feature-name>"
echo "  2. View help — run: bash references/scripts/help.sh"
echo "  3. Check status — say: what's our status"
echo ""
