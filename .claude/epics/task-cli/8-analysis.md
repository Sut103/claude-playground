...
本 Issue は単一のモジュール `taskcli/cli.py` に閉じており、内部にさらなる並列ストリームを持たない。
...
### Stream A: コマンド層
**Scope**: コマンド層 の実装とその単体テスト
**Files**: `taskcli/cli.py`、`tests/test_cli.py`
...
## Expected Timeline
- With parallel execution: 6h wall time（3 本の最長）
- Without: 12h
- Efficiency gain: 50%
